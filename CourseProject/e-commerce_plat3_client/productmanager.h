...
private:
    ...
    QuantityWidget *quantity_widget;    //数量部件
    QPushButton *add_cart_btn;          //添加按钮
    void sendAddToCartSignal();         //向购物车发送信号，由添加按钮触发
public:
    explicit ProductDisplayer(User *user, QVector<Product *> &list, int index, QWidget *parent = nullptr);
